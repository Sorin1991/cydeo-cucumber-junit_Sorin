Feature: Web table user order feature
  ...
  Scenario: Used should be able to place order and order seen in web table
    ...
    Then user should see "Sherlock Holmes" in first row of the web table
      ...
      #Scenario Outline: and Template are the same


  Scenario Template: Used should be able to place order and order seen in web table
    Given user is already logged in and on order page
    ...
    Examples: Famous female scientist
      ...
      | MoneyCog    | 5        | Chien-Shung Wu     | London st | London | England | 50505   | Visa     | 1111222233334444 | 12/24   | Chien-Shung Wu     |
    ...
    Examples: Famous male scientists
      ...
      | MoneyCog    | 3        | Albert Einstein       | London st | London | England | 50505   | Visa     | 1111222233334444 | 12/24   | Albert Einstein       |
      | MoneyCog    | 4        | CV Raman              | London st | London | England | 50505   | Visa     | 1111222233334444 | 12/24   | CV Raman              |
